...
class BookIt {
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $basePath = $this->modx->getOption('bookit.core_path',$config,$this->modx->getOption('core_path').'components/bookit/');
        $assetsUrl = $this->modx->getOption('bookit.assets_url',$config,$this->modx->getOption('assets_url').'components/bookit/');
