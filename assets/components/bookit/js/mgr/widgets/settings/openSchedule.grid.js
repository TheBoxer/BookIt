Bookit.grid.OpenSchedule = function(config) {
    ...
    Ext.applyIf(config,{
        ...
        ,openScheduleSettings: function() {
        	location.href = 'index.php?a='+MODx.request.a+'&action=openScheduleItems'+'&id='+this.menu.record.id;
        }
        ,pricing: function() {
        	location.href = 'index.php?a='+MODx.request.a+'&action=pricing'+'&id='+this.menu.record.id;
        }
        ,columns: [{
